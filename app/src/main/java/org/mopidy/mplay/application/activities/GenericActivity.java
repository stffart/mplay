...
public abstract class GenericActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onResume() {
        ...
        WSInterface.getGenericInstance().addMPDConnectionStateChangeListener(mConnectionCallback);
    ...
    protected void onPause() {
        ...
        WSInterface.getGenericInstance().removeMPDConnectionStateChangeListener(mConnectionCallback);
