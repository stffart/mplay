...
public class CurrentPlaylistAdapter extends BaseAdapter implements ArtworkManager.onNewAlbumImageListener, ScrollSpeedAdapter, SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        if (track != null) {
            ...
            if (type == VIEW_TYPES.TYPE_TRACK_ITEM) {
                if (convertView == null) {
                    ...
                    convertView = new FileListItem(mContext, true, null);
                }
                ...
                tracksListViewItem.setTrack(track, true);
                tracksListViewItem.setTrackNumber(String.valueOf(position + 1));
                tracksListViewItem.setArtwork(track.getArtwork("200"));
    ...
    private static class ConnectionStateChangeListener extends MPDConnectionStateChangeHandler {
        ...
        public void onConnected() {
            ...
            MPDCapabilities capabilities = WSInterface.getGenericInstance().getServerCapabilities();
    ...
    public void onResume() {
        ...
        WSInterface.getGenericInstance().addMPDConnectionStateChangeListener(mConnectionListener);
    ...
    public void onPause() {
        ...
        WSInterface.getGenericInstance().removeMPDConnectionStateChangeListener(mConnectionListener);
