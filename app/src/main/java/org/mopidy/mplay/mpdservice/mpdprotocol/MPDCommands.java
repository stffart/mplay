...
public class MPDCommands {
    ...
    public static String MPD_COMMAND_REQUEST_ARTIST_ALBUMS(String artistName, MPDCapabilities caps) {
        if (caps.hasListGroup()) {
            return "lsinfo album artist \"" + escapeString(artistName) + "\"" + createAlbumGroupString(caps);
        } else {
            return "list album \"" + escapeString(artistName) + "\"";
        }
    }

    public static String MPD_COMMAND_REQUEST_ARTIST_URI_ALBUMS(String artistUri) {
        return "lsinfo \"" + escapeString(artistUri) + "\"";
    }
    ...
    public static String MPD_COMMAND_REQUEST_ALBUM_TRACKS(String albumUri) {
        return "lsinfo \"" + escapeString(albumUri) + "\"";
    }

    public static String MPD_COMMAND_REQUEST_ARTISTS(boolean groupMBID) {
        if (!groupMBID) {
            return "find artist _____";
        } else {
            return "find artist _____";
        }
    }
