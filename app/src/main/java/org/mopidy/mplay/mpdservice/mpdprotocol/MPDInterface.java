...
public class MPDInterface {
     ...
     */
    public List<MPDAlbum> getArtistAlbums(String artistUri) throws MPDException {
        ...
        if (capabilities.hasTagAlbumArtist() && capabilities.hasListGroup()) {
            ...
            synchronized (this) {
                ...
                mConnection.sendMPDCommand(MPDCommands.MPD_COMMAND_REQUEST_ARTIST_URI_ALBUMS(artistUri));
    ...
    public List<MPDFileEntry> getAlbumTracks(String albumURI) throws MPDException {
        List<MPDFileEntry> result;
        synchronized (this) {
            mConnection.sendMPDCommand(MPDCommands.MPD_COMMAND_REQUEST_ALBUM_TRACKS(albumURI), MPDConnection.BROWSE_RESPONSE_TIMEOUT);
    ...
    public List<MPDFileEntry> getFiles(String path) throws MPDException {
        ...
        synchronized (this) {
            mConnection.sendMPDCommand(MPDCommands.MPD_COMMAND_GET_FILES_INFO(path),MPDConnection.BROWSE_RESPONSE_TIMEOUT);
