...
public class MPDServerProfileTable {
    ...
    public static final String COLUMN_SERVER_REMOTE_HOSTNAME = "server_remote_hostname";
    ...
    public static final String COLUMN_SERVER_REMOTE_PORT = "server_remote_port";
    ...
    public static final String[] PROJECTION_SERVER_PROFILES = {COLUMN_PROFILE_NAME, COLUMN_PROFILE_AUTO_CONNECT,
        COLUMN_SERVER_HOSTNAME, COLUMN_SERVER_REMOTE_HOSTNAME, COLUMN_SERVER_LOGIN, COLUMN_SERVER_PASSWORD, COLUMN_SERVER_PORT, COLUMN_SERVER_REMOTE_PORT, COLUMN_PROFILE_DATE_CREATED,
    ...
    public static final String DATABASE_CREATE = "create table if not exists " +  SQL_TABLE_NAME + " (" +
            ...
            COLUMN_SERVER_HOSTNAME + " text," +COLUMN_SERVER_REMOTE_HOSTNAME + " text," + COLUMN_SERVER_LOGIN + " text," + COLUMN_SERVER_PASSWORD + " text," +
            COLUMN_SERVER_PORT  + " integer," +COLUMN_SERVER_REMOTE_PORT   + " integer," + COLUMN_PROFILE_DATE_CREATED  + " integer PRIMARY KEY, " +
